...
import HomiesWelcomeContainer from "./homies/homies_welcome_container";
...
const App = () => (
  <>
      ...
      <ProtectedRoute exact path="/servers/@me" component={HomiesWelcomeContainer} />
      <ProtectedRoute exact path="/servers/@me/:serverId/:homieId" component={DirectMessageIndexContainer} />
